...
static t9p_rtems_node_t* t9p_rtems_fs_get_node(const rtems_filesystem_location_info_t* loc) {
    return loc->node_access;
}

static t9p_rtems_node_t* t9p_rtems_iop_get_node(const rtems_libio_t* iop) {
    return iop->data1;
}
